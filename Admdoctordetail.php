...
<tr><th>Doctor Details</th></tr>
<tr><td>
<?php

$q="select *from doctordetail";
$result=mysqli_query($con,$q);
echo "".mysqli_error($con);

echo "<table border='2' align='center' cellpadding='10'>";
echo "<tr><th>Doctor Id</th><th>Doctor Name</th><th>Age</th><th>Gender</th><th>Address</th><th>City</th><th>Contact</th><th>Department</th></tr>";
while($r=mysqli_fetch_assoc($result))
{
echo "<tr><td>".$r['did']."</td><td>".$r['dname']."</td><td>".$r['age']."</td><td>".$r['gender']."
	</td><td>".$r['addres']."</td><td>".$r['city']."</td><td>".$r['contact']."</td><td>".$r['special']."</td></tr>";
}
?>
